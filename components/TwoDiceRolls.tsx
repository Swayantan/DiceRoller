...
export default function App(): JSX.Element {
  ...
  const changeDice1 = () => {
    setDiceImage1(rollDiceOnTap());
  };
  const changeDice2 = () => {
    setDiceImage2(rollDiceOnTap());
  };
  return (
    <View style={styles.container}>
      <View style={styles.heading}>
        <Text style={styles.headingTxt}>Two Dice Rolls</Text>
      </View>
      <View>
        {/* <Dice imageUrl={diceImage.dice1} /> */}
        <Dice imageUrl={diceImage1} />
        <Pressable onPress={changeDice1}>
